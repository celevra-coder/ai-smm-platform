...
const [notificationTarget, setNotificationTarget] = useState<"/en/contact" | "/en/account">("/en/contact");
...
setNotificationTarget("/en/contact");
return;
    }
...
setNotificationTarget(videoIds.length > 0 ? "/en/account" : "/en/contact");
  };
