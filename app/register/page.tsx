...
<button
  ...
  className="mb-4 flex w-full items-center justify-center gap-3 rounded-xl border border-neutral-300 bg-white px-4 py-3 font-medium text-neutral-900 transition hover:bg-neutral-50"
>
  <svg
