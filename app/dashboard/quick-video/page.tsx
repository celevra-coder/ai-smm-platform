...
const buildQuickVideoPrompt = () => {
  ...
  realismRules +=
    " Create a realistic BARF pet food commercial video. Show a realistic dog and realistic cat eating from two simple matte bowls placed on a warm wooden floor or cozy modern home kitchen floor. The food inside the bowls must be ONLY fresh raw minced meat with visible soft minced texture, small uneven ground meat particles, moist raw meat appearance, realistic raw beef or chicken mince texture. The food must clearly look like raw minced meat for pets. NEVER show dry kibble, pellets, granules, biscuit food, canned chunks, steak pieces, whole meat cuts, cooked meat, grilled meat, sausages, vegetables, rice, garnish, or human restaurant food. The animals should naturally lower their heads and lick or bite the minced meat in a believable feeding motion. Use cinematic close-up feeding shots and realistic pet behavior. The background must be ONLY cozy home environment, minimal Scandinavian-style kitchen, warm pet owner home, or natural lifestyle interior. NEVER show pharmacy, veterinary clinic, pet store shelves, medicine products, supermarket, laboratory, hospital, white medical room, industrial room, restaurant kitchen, commercial shelves, product displays, or retail environment. No packaging. No labels. No text. No logos.";
}
  ...
  return `${videoIdea.trim()}. ${businessDescription.trim()}. ${realismRules} Negative details: kibble, pellets, granules, dry pet food, steak, steak pieces, grilled meat, cooked meat, sausage, vegetables, rice, pharmacy, vet clinic, medicine shelves, medical room, laboratory, hospital, supermarket, store shelves, retail shop, restaurant kitchen, fake food texture, plastic meat, frozen chewing, unrealistic pet mouth, distorted animals, floating food, CGI food, cartoon food.`;
};
